...
<html lang="ja">
  <head>
    ...
    <link rel="stylesheet" href="../assets/css/master03-04.css">
  </head>
...
print <<<HTML
    <main class="inner-03-04 status-client">
        ...
        <div class="block_inner">
          ...
          <article class="inner_search-list">
            <form name="inputForm" class="inputForm box-new-entry">
              ...
              <input type="text" name="newCategoryName" class="required-item" placeholder="カテゴリ名を入力" required maxlength="255">
            ...
            <ul class="drag-area">
              <li>
                <div></div>
                <div>ID</div>
                <div style="align-items: flex-start">カテゴリ名</div>
                <div></div>
              </li>
...
if (!empty($itemCategoryList)) {
  $totalCategoryCount = count($itemCategoryList);
  $categoryIndex = 0;
  foreach ($itemCategoryList as $itemCategory) {
    ...
    $isLast = ($categoryIndex === ($totalCategoryCount - 1));
    ...
    print <<<HTML
              <li>
                ...
                <nav>
                  ...
                  <button class="btn-edit" type="button" data-tooltip="編集" aria-label="編集" onclick="editCategory(this)"></button>
                  <button class="btn-delate" type="button" data-tooltip="削除" aria-label="削除" onclick="deleteCategory(this)"></button>
                </nav>
              </li>
...
print <<<HTML
    ...
    <script src="./assets/js/client03_04.js" defer></script>
  </body>
</html>
