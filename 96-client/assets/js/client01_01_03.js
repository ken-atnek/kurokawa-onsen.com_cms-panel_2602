 ...
 *
 */
const requestURL = "./assets/function/proc_client01_01_03.php";
    ...
    if (errFlag === 0) {
        ...
        try {
            ...
            if (list["status"] == "error") {
                ...
                //一覧へ戻るボタン生成
                let newButton = `<button type="button" class="btn-cancel" onclick="closeModalToPage('client01_01_03.php');">閉じる</button>`;
                blockModal.querySelector(".box-btn").insertAdjacentHTML("beforeend", newButton);
                //「✕」ボタンも変更
                blockModal.querySelector(".box-title").querySelector("button").setAttribute("onclick", "closeModalToPage('client01_01_03.php')");
            }
