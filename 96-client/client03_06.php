...
#----------------#
#セッションキー
$searchConditionsSessionKey = 'searchConditions_client03_06';
$pagePrefix = 'cKey03-06_';
...
foreach ($_SESSION as $key => $val) {
  ...
  if ($key !== 'sKey' && $key !== 'client_login' && $key !== 'client_csrf_token' && $key !== $noUpDateKey && $isSearchConditionsKey === false) {
    unset($_SESSION[$key]);
  }
}
#セッション本体の初期化
...
$backUrl = './client03_06.php?searchYear=' . rawurlencode((string)$targetYear) . '&searchMonth=' . rawurlencode((string)$targetMonth);
...
print <<<HTML
  <main class="inner-03-06-01 status-client">
    ...
    <div class="main-contents menu-color03">
      <div class="block_inner">
        ...
        <form name="searchForm" class="inner-summary-list">
          ...
          <input type="hidden" name="shopId" value="{$shopIdHtml}">
...
print <<<HTML
  ...
  <script src="./assets/js/client03_06.js" defer></script>
</body>
